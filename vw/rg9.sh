...
# server settings
cd /etc/openvpn/
wget -O /etc/openvpn/server.conf "https://raw.githubusercontent.com/kakitong/tong/main/vw/server.conf"
...
# openvpn config
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/kakitong/tong/main/vw/client.conf"
